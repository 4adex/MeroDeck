...
CLASS_HASH=$(starkli declare target/dev/contracts_cairo_token.contract_class.json --network=sepolia)
...
# app/src/constants/contractData.json
echo "Writing the contract address to the frontend..."
OUTPUT_FILE="../app/src/constants/contractData.json"
cat <<EOF > "$OUTPUT_FILE"
{
